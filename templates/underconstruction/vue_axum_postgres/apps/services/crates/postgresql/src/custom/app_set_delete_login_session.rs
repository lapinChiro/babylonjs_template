...
mod tests {
    ...
    // RUST_LOG=info REALM_CODE=test cargo test -p postgresql test_postgresql_app_set_delete_login_session -- --nocapture --test-threads=1
    #[tokio::test]
    async fn test_postgresql_app_set_delete_login_session () -> anyhow::Result<()> {
