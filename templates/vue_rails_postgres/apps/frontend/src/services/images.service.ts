 ...
 */
async function requestUploadUrl(data: UploadUrlRequest): Promise<UploadUrlResponse> {
  try {
 ...
 */
async function confirmUpload(data: ConfirmUploadRequest): Promise<ImageResponse> {
  try {
