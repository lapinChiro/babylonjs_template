<template>
  <div class="w-full">
    ...
    <!-- 画像グリッド -->
    <div
      v-if="imagesStore.sortedImages.length > 0"
    ...
    <!-- アップロードダイアログ -->
    <ImageUploadDialog :open="showUploadDialog" @close="showUploadDialog = false" />
...
const ImageUploadDialog = defineAsyncComponent(() => import('./ImageUploadDialog.vue'))
const ImagePreviewDialog = defineAsyncComponent(() => import('./ImagePreviewDialog.vue'))
const ImageDeleteDialog = defineAsyncComponent(() => import('./ImageDeleteDialog.vue'))
